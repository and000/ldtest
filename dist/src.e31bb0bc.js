...
},{}],"kirby.png":[function(require,module,exports) {
module.exports = "/kirby.ffacdfc7.png";
...
exports.Player = exports.Gameobject = void 0;
...
var _kirby = _interopRequireDefault(require("./kirby.png"));
...
/*#__PURE__*/
function () {
  function Gameobject(posx, posy, velx, vely, rotation) {
    (0, _classCallCheck2.default)(this, Gameobject);
    this.pos = new _victor.default(posx, posy);
    this.vel = new _victor.default(velx, vely);
    this.acc = new _victor.default(0, 0);
    this.friction = new _victor.default(0.97, 0.97);
    this.rotation = rotation;
    this.baseline = this.pos.clone();
    this.gravity = new _victor.default(0, 0.05);
    this.onGround = true;
    this.jumps = 15;
    this.jumping = false;
    ...
    this.sprite.src = _kirby.default;
    this.width = 128;
    this.height = 64;
    this.count = 0;
  }

  (0, _createClass2.default)(Gameobject, [{
    key: "update",
    value: function update() {
      ...
      if (this.pos.x < 0) this.pos.x = this.width + 10; //update velocity

      this.vel.add(this.acc); //cheat's friction (friction = 0.97) - this is a cheat, not real phyics

      this.vel.multiply(this.friction); //update position
      ...
      this.acc.multiply(new _victor.default(0.85, 0.85));
    }
  }, {
    key: "draw",
    ...
    key: "drawSprite",
    value: function drawSprite(ctx, count) {
      ...
      if (this.onGround) {
        ...
        if (this.acc.y < 0.1) count %= 6;else count = 6;
      }

      if (this.vel.x < 0) ctx.scale(-1, 1);
      if (this.onGround) ctx.drawImage(this.sprite, 8 + count * 23, 55, 23, 25, -10, -10, 20, 20); // jumping
      else ctx.drawImage(this.sprite, 8 + count * 24, 130, 23, 25, -10, -10, 20, 20);
    }
  }]);
  return Gameobject;
}();
...
function (_Gameobject) {
  (0, _inherits2.default)(Player, _Gameobject);

  function Player() {
    (0, _classCallCheck2.default)(this, Player);
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(Player).call(this));
  }
...
},{"@babel/runtime/helpers/possibleConstructorReturn":"../node_modules/@babel/runtime/helpers/possibleConstructorReturn.js","@babel/runtime/helpers/getPrototypeOf":"../node_modules/@babel/runtime/helpers/getPrototypeOf.js","@babel/runtime/helpers/inherits":"../node_modules/@babel/runtime/helpers/inherits.js","@babel/runtime/helpers/classCallCheck":"../node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"../node_modules/@babel/runtime/helpers/createClass.js","victor":"../node_modules/victor/index.js","./kirby.png":"kirby.png"}],"index.js":[function(require,module,exports) {
"use strict";
...
var stats = new _statsJs.default();
...
var spaceship = new _player.Gameobject(20, 59, 0, 0, 0);
...
init();
animate();
},{"stats-js":"../node_modules/stats-js/build/stats.min.js","dat.gui":"../node_modules/dat.gui/build/dat.gui.module.js","./player":"player.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
